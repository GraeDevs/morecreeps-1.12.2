...
public class CreepsSoundHandler
{
    ...
    public static final SoundEvent invisibleManSound = createSound("invisibleman");

    public static final SoundEvent invisibleManHurt = createSound("invisiblemanhurt");

    public static final SoundEvent invisibleManAngry = createSound("invisiblemanangry");

    public static final SoundEvent invisibleManDeath = createSound("invisiblemandeath");

    public static final SoundEvent invisibleManForget = createSound("invisiblemanforgetit");
    ...
    public static final SoundEvent hunchQuietSound = createSound("hunchquiet");

    public static final SoundEvent hunchCakeSound = createSound("hunchcake");

    public static final SoundEvent hunchHurtSound = createSound("hunchhurt");

    public static final SoundEvent hunchDeathSound = createSound("hunchdeath");
